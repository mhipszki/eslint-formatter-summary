...
test('can sort summary by rule id', () => {
  ...
  expect(format(results, argv('rule'))).toMatchSnapshot();
  expect(format(results, argv('rule', 'desc'))).toMatchSnapshot();
});
...
test('can sort summary by num of errors', () => {
  ...
  expect(format(results, argv('errors'))).toMatchSnapshot();
  expect(format(results, argv('errors', 'desc'))).toMatchSnapshot();
});
...
test('can sort summary by num of warnings', () => {
  ...
  expect(format(results, argv('warnings'))).toMatchSnapshot();
  expect(format(results, argv('warnings', 'desc'))).toMatchSnapshot();
});
